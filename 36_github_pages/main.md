...
**Страницы GitHub можно использовать для различных целей, например:**
...
12. Можно ли использовать GitPages для размещения частных репозиториев? Почему да или почему нет?
13. Как включить непрерывное развертывание с помощью GitPages?
14. Опишите процесс настройки пользовательской страницы ошибки 404 для вашего веб-сайта GitPages. 
